    ...
    <div className="nav-item absolute right-5 md:right-52 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
      <div className="flex items-center justify-between">
        <div className="flex gap-3">
          ...
          <button
            type="button"
            className={`p-1 px-2 text-xs text-white bg-black rounded dark:text-black dark:bg-white`}
          >
            5 New
          </button>
        </div>
      ...
      <div className="mt-5 ">
        {chatData?.map((item, index) => (
          <div
            key={index}
            className="flex items-center gap-5 p-3 leading-8 cursor-pointer border-b-1 border-color"
          >
